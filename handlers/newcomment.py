...
class NewCommentHandler(BaseHandler):
    ...
    def render_main(self, post_id, author, get_new_comment=False, error=""):
    ...
    def get(self, post_id):
        ...
        if self.logged_in():
            self.render_main(post_id, author, get_new_comment=True)
        else:
    ...
    def post(self, post_id):
        ...
        if comment_content:
            ...
            self.render_main(post_id, author, get_new_comment=False,
